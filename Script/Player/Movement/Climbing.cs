...
public class Climbing : MonoBehaviour
{
    ...
    private void StateMachine()
    {
        ...
        {
            if (pm.grounded && !climbing && climbTimer > 0 && SC.stamina > SC.minStamina) //Input.GetKey(pm.sprintKey) &&
                StartClimbing();
            else if(!pm.grounded && !climbing && climbTimer > 0 && SC.stamina > SC.minStamina) 
                StartClimbing();
